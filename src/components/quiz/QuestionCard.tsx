    ...
    <div className="flex flex-col">
      ...
      <div className="mb-7 flex flex-wrap items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          {isConceptual && (
            <span className="rounded-[5px] bg-accent-tint px-2 py-0.5 text-xs font-medium text-accent-strong">
              Discussion
            </span>
          )}
        </div>
      ...
      {/* Check Answer — answering phase only */}
      {!isLocked && (
